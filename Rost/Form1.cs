        ...
        */
        ...
        private void button1_Click(object sender, EventArgs e)
        {
         ...
         //   else
            ...
            if (sl1 == 0)
            {
                MessageBox.Show("Неправильный ответ!, если коэффициент прироста работников будет больше, то мощности будут простаивать");
            }
            if (sl1 == 1)
            {
                MessageBox.Show("Неправильный ответ!, т.к. мы рассматриваем рынки с развивающейся экономикой, то коэффициента убытия работников не существует");
            }
            if (sl1 == 2)
            {
                MessageBox.Show("Правильный ответ! Оптимальное значение роста достигается в точке, когда коэффициенты роста производственных сил примерно равны");
            }
